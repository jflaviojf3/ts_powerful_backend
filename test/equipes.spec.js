...
describe.skip('Testes dos endpoints de equips', ()=>{
    ...
    it('Teste para deletar um usuario id 1 da equipe, deve retornar 200', async ()=>{
        ...
        expect(res.statusCode).toEqual(200)
        expect(res.body.mensagem).toEqual(`Id EquipeUsuario ${id_equipeUsuario1_criado} deletado`)
    })
    ...
    it('Teste para deletar um usuario id 2 da equipe, deve retornar 200', async ()=>{
        ...
        expect(res.statusCode).toEqual(200)
        expect(res.body.mensagem).toEqual(`Id EquipeUsuario ${id_equipeUsuario2_criado} deletado`)
    })
    ...
    it('Teste para deletar uma equipe, deve retornar 200', async ()=>{
        ...
        expect(res.statusCode).toEqual(200)
        expect(res.body.mensagem).toEqual(`Id Equipe ${id_equipes_criado} deletado`)
    })
