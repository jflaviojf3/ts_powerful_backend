...
describe.skip('Testes dos endpoints de parametros', ()=>{
    ...
    it('Teste para consultar todos os parametros, deve retornar 200', async ()=>{
        ...
        expect(res.body[res.body.length - 1].descricao_propriedade).toEqual("Novo Parametro")
    ...
    it('Teste para deletar parametro que foi atualizado, deve retornar 200', async ()=>{
        ...
        expect(res.statusCode).toEqual(200)
        expect(res.body.mensagem).toEqual(`Id parametro ${id_tabGenerica_criada} deletado`)
    })
