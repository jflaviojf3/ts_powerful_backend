...
describe.only('Testes dos endpoints de clientes', ()=>{
    ...
    it('Teste para consultar um cliente, deve retornar 200', async ()=>{
        ...
        expect(res.body.descricao).toEqual("Analise, codificação, teste, implantação e treinamento do sistema para o cliente")
    ...
    it('Teste para criar novo cliente, deve retornar 200', async ()=>{
        ...
        .send({
            ...
            "descricao": "Descrição para um novo cliente criado via Automatizado no JEST",
            "cod_prioridade": 3
        })
        ...
        expect(res.body.descricao).toEqual("Descrição para um novo cliente criado via Automatizado no JEST")
    ...
    it('Teste para deletar cliente que foi atualizado, deve retornar 200', async ()=>{
        ...
        expect(res.statusCode).toEqual(200)
        expect(res.body.mensagem).toEqual(`Id Cliente ${id_cliente_criado} deletado`)
    })
